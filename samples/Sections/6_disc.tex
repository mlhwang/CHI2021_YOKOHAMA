...
% key contributions:    (notes based on intro)
% 1. integrating avatars and crowdsourced CB to help engagement with nutritional info
%%%%%%% so this one is more about the integration of the two mechanisms...
% 2. shows the potential of our app to engage users, help improve nutritional literacy, and establish and maintained by the crowd
%%%%%%% this one is about by the crowd for the crowd?
% 3. emphasizes the role of PAID in influencing engagement/enjoyment and possibly learning
%%%%%%% focuses on the role of PAID and potential learning
...
%(1) This work integrates previously disconnected gamification and social mechanisms (tamagotchi-style mechanism and crowdsourced community board) to facilitate engagement with and deliver nutritional information in a new context; (2) This paper shows that a lightweight app such as Monster Munch has the potential to engage users and help them improve nutritional literacy and can be established and maintained by the crowd and for the crowd; (3) This study emphasizes the role that player-avatar-identification may have in shaping users' engagement and enjoyment of the app and possible effects on recollection and learning outcomes.

% \vspace{-5pt}
% \subsection{Gamification Mechanisms for User Experience and Engagement}
...
In the pilot study, users were allowed to choose a monster avatar with specific health goals and then were allowed to name their pet avatar. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% LEARNING %%%%%%%%%%%%%
\vspace{-5pt}
\subsection{Gamification Mechanisms on Nutritional Learning}
